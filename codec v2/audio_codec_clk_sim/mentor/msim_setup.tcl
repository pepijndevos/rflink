...
# ----------------------------------------
# If audio_codec_clk is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.0 614 win32 2018.12.10.16:18:57
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "audio_codec_clk"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/audio_codec_clk.vho"
}
