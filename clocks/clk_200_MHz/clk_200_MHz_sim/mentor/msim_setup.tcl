...
# ----------------------------------------
# If clk_200_MHz is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 625 linux 2018.12.21.13:01:41
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "clk_200_MHz"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/data/Programs/Quartus/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clk_200_MHz.vho"
}
