...
# ----------------------------------------
# If clk_20_MHz is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 625 win32 2019.01.07.12:02:13
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clk_20_MHz.vho"
}
