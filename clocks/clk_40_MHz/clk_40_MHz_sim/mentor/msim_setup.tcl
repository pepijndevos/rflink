...
# ----------------------------------------
# If clk_40_MHz is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.0 614 win32 2018.12.22.16:41:59
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clk_40_MHz.vho"
}
