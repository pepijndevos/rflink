...
# ACDS 18.0 614 win32 2018.12.22.18:48:26
# ----------------------------------------
...
# ----------------------------------------
# If clk_3_40_MHz is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "clk_3_40_MHz"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clk_3_40_MHz.vho"
}
